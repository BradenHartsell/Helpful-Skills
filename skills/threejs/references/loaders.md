...
// Host decoder artifacts yourself, or use a version-pinned path that matches
// the installed Three.js package.
...
// Host transcoder artifacts yourself, or use a version-pinned path that matches
// the installed Three.js package.
